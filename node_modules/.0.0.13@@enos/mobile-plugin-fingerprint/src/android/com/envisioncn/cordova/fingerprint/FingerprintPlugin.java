                    ...
                    try {
                        FingerprintHelper.authenticate(new FingerprintHelper.FingerPrintResult() {
                            ...
                            public void error(int code, CharSequence info) {
                                mFingerprintDialog.dismiss();
                                if (code == -1) {
                                    callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, FINGERPRINT_ERROR_NOT_SUPPORT));
                                } else {
                                    callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, FINGERPRINT_ERROR_LOCKOUT));
                                }
                            }
