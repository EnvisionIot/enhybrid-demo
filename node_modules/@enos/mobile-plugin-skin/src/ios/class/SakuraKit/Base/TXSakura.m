...
NSString *const kTXSakuraArgGradientImage = @"com.tingxins.sakura.arg.gradient.image";
...
- (TXSakuraBlock)tx_sakuraBackgroundImageBlockWithName:(NSString *)name {
    return ^TXSakura *(NSString *path){
        return [self send1DMsgObjectWithName:name keyPath:path arg:kTXSakuraArgGradientImage valueBlock:^NSObject *(NSString *keyPath) {
            return [TXSakuraManager tx_imageGradientWithPath:keyPath];
        }];
    };
}
